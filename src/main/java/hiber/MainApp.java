...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      User user1 = new User("User1", "LastName1", "email1@mail.io");
      User user2 = new User("User2", "LastName2", "email2@mail.io");
      User user3 = new User("User3", "LastName3", "email3@mail.io");
      User user4 = new User("User4", "LastName4", "iemail4@mail.io");
